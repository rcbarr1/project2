...
experiment_names = ['exp20_2025-10-13-ssp_none-MLD-all_lat_lon-dt_1year']
...
#%%
plt.plot(t[1::], atmospheric_xCO2[1::])
plt.plot(atmospheric_xCO2_time[2015:2215] - 2015, atmospheric_xCO2_annual[2015:nt+2015])
#lt.plot(t, atmospheric_xCO2_interped)
plt.xlim([55, 60])
plt.ylim([0.00047, 0.000475])
